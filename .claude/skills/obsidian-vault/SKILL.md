---
name: obsidian-vault
description: Search, create, and manage notes in the Bullet Heaven Obsidian vault with wikilinks. Use when the user wants to find, create, or organize notes in Obsidian.
---

# Obsidian Vault — Bullet Heaven

## Vault location

`/home/alon/Desktop/Bullet-Heaven/Notes/`

This is a standalone game vault. The portal vault reaches it via a symlink
(`~/Desktop/game/Games/Bullet-Heaven`) — edit from either side, one source of truth.
...
### Search
```bash
find "/home/alon/Desktop/Bullet-Heaven/Notes/" -name "*.md" | grep -i "keyword"   # by filename
grep -rl "keyword" "/home/alon/Desktop/Bullet-Heaven/Notes/" --include="*.md"      # by content
```
...
### Find backlinks
```bash
grep -rl "\[\[Note Title\]\]" "/home/alon/Desktop/Bullet-Heaven/Notes/" --include="*.md"
```
